<footer class="full-row bg-secondary p-0">
            <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
                                        <h4 class="widget-title text-white double-down-line-left position-relative"> RentaNathi Properties</h4>
                                        <p class="pb-20 text-white">Renta Nathi is an online platform that allows Landlords to list their properties that are available to be rented by a tenant. It also allows tenents to view listed apartments. </p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget">
                                                ...
                                                <ul class="text-white">
                                                    <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>14 Diederich Str, Witbank</li>
                                                    <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+27 12-567-8910</li>
													<li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+27 12-765-4321</li>
                                                    <li class="hover-text-primary"><i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>info@rentanathi.com</li>
                                                </ul>
                                            </div>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white"> Copyright © <?php echo date('Y');?> RantaNathi Properties</span> </div>
                    <div class="col-sm-6">
